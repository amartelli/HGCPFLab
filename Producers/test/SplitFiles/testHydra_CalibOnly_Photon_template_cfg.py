...
##                                         fileName = cms.untracked.string('file:muon10GeV_Calib.root'),
#                                         fileName = cms.untracked.string('file:/tmp/amartell/photon_Calib.root'),
...
#                                   fileName = cms.string("histoMuon10GeV_calib.root"),
...
process.ep = cms.EndPath(process.HydraCaloCalibrator)
