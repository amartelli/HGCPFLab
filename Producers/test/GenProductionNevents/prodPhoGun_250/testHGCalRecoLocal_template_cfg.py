...
#process.load('IOMC.RandomEngine.python.IOMC_cff')
...
process.RandomNumberGeneratorService = cms.Service("RandomNumberGeneratorService",
                                                   generator = cms.PSet(
                initialSeed = cms.untracked.uint32(99099),
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('SinglePhotonE250_cfi nevts:10'),
...
process.RandomNumberGeneratorService.generator.initialSeed = FIRSTEVENT 

process.generator = cms.EDProducer("FlatRandomEGunProducer",
    PGunParameters = cms.PSet(
        MaxE = cms.double(251.0),
        MinE = cms.double(249.0),
    ...
    psethack = cms.string('single photon E 250'),
