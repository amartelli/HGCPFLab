...
#process.load('IOMC.RandomEngine.python.IOMC_cff.py')
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('SinglePhotonE60_cfi nevts:10'),
...
process.generator = cms.EDProducer("FlatRandomEGunProducer",
    PGunParameters = cms.PSet(
        MaxE = cms.double(61.0),
        MinE = cms.double(59.0),
    ...
    psethack = cms.string('single photon E 60'),
