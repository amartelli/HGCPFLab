...
void doPlots_Fit_all(){
  ...
  */
  ...
  TFile* inF[5];
  inF[0] = TFile::Open("hydra_CalibOnly_PhoE10.root");
  inF[1] = TFile::Open("hydra_CalibOnly_PhoE30.root");
  inF[2] = TFile::Open("hydra_CalibOnly_PhoE60.root");
  inF[3] = TFile::Open("hydra_CalibOnly_PhoE100.root");
  inF[4] = TFile::Open("hydra_CalibOnly_PhoE250.root");

  //vs gen                                                                                                                                                                      

  TH1F* h_EoP_hitTrack_100[5];
  TH1F* h_EoP_hitTrack_200[5];
  TH1F* h_EoP_hitTrack_300[5];



  TF1* fitF_100[5];
  fitF_100[0] = new TF1("Si100_E10", "gaus", 0.7, 1.1 );
  fitF_100[1] = new TF1("Si100_E30", "gaus", 0.7, 1.1 );
  fitF_100[2] = new TF1("Si100_E60", "gaus", 0.7, 1.1 );
  fitF_100[3] = new TF1("Si100_E100", "gaus", 0.7, 1.1 );
  fitF_100[4] = new TF1("Si100_E250", "gaus", 0.7, 1.1 );
  //  fitF_60->SetParameters(600, 0.92, 1.5);
  TF1* fitF_200[5];
  fitF_200[0] = new TF1("Si200_E10", "gaus", 0.7, 1.1 );
  fitF_200[1] = new TF1("Si200_E30", "gaus", 0.7, 1.1 );
  fitF_200[2] = new TF1("Si200_E60", "gaus", 0.7, 1.1 );
  fitF_200[3] = new TF1("Si200_E100", "gaus", 0.7, 1.1 );
  fitF_200[4] = new TF1("Si200_E250", "gaus", 0.7, 1.1 );
  //
  TF1* fitF_300[5];
  fitF_300[0] = new TF1("Si300_E10", "gaus", 0.7, 1.1 );
  fitF_300[1] = new TF1("Si300_E30", "gaus", 0.7, 1.1 );
  fitF_300[2] = new TF1("Si300_E60", "gaus", 0.7, 1.1 );
  fitF_300[3] = new TF1("Si300_E100", "gaus", 0.7, 1.1 );
  fitF_300[4] = new TF1("Si300_E250", "gaus", 0.7, 1.1 );


  int colorsExt[6] = {kViolet, kRed, kBlue, kRed+2, kGreen+2};
  ...
  TLegend *leg = new TLegend(0.70,0.70,0.95,0.95,NULL,"brNDC");
  leg->SetTextFont(42);
  leg->SetFillColor(kWhite);
  leg->SetLineColor(kWhite);
  leg->SetShadowColor(kWhite);
  leg->AddEntry(h_EoP_hitTrack_100[0], "#gamma E=10GeV", "l");
  leg->AddEntry(h_EoP_hitTrack_100[1], "#gamma E=30GeV", "l");
  leg->AddEntry(h_EoP_hitTrack_100[2], "#gamma E=60GeV", "l");
  leg->AddEntry(h_EoP_hitTrack_100[3], "#gamma E=100GeV", "l");
  leg->AddEntry(h_EoP_hitTrack_100[4], "#gamma E=250GeV", "l");
  ...
  h_EoP_hitTrack_100[0]->Fit("Si100_E10", "R");
  h_EoP_hitTrack_100[1]->Fit("Si100_E30", "R");
  h_EoP_hitTrack_100[2]->Fit("Si100_E60", "R");
  h_EoP_hitTrack_100[3]->Fit("Si100_E100", "R");
  h_EoP_hitTrack_100[4]->Fit("Si100_E250", "R");
  ...
  h_EoP_hitTrack_200[0]->Fit("Si200_E10", "R");
  h_EoP_hitTrack_200[1]->Fit("Si200_E30", "R");
  h_EoP_hitTrack_200[2]->Fit("Si200_E60", "R");
  h_EoP_hitTrack_200[3]->Fit("Si200_E100", "R");
  h_EoP_hitTrack_200[4]->Fit("Si200_E250", "R");
  ...
  h_EoP_hitTrack_300[0]->Fit("Si300_E10", "R");
  h_EoP_hitTrack_300[1]->Fit("Si300_E30", "R");
  h_EoP_hitTrack_300[2]->Fit("Si300_E60", "R");
  h_EoP_hitTrack_300[3]->Fit("Si300_E100", "R");
  h_EoP_hitTrack_300[4]->Fit("Si300_E250", "R");
  ...
  h_EoP_hitTrack_100[0]->GetYaxis()->SetRangeUser(0., 1200);
  ...
  t10.DrawLatex(0.15,0.9,Form("m = %.2e +/- %.2e   #sigma = %.2e +/- %.2e", fitF_100[0]->GetParameter(1), fitF_100[0]->GetParError(1), 
   			     fitF_100[0]->GetParameter(2), fitF_100[0]->GetParError(2)));
  t30.DrawLatex(0.15,0.85,Form("m = %.2e +/- %.2e   #sigma = %.2e +/- %.2e", fitF_100[1]->GetParameter(1), fitF_100[1]->GetParError(1), 
   			     fitF_100[1]->GetParameter(2), fitF_100[1]->GetParError(2)));
  t3a.DrawLatex(0.15,0.8,Form("m = %.2e +/- %.2e   #sigma = %.2e +/- %.2e", fitF_100[2]->GetParameter(1), fitF_100[2]->GetParError(1), 
   			     fitF_100[2]->GetParameter(2), fitF_100[2]->GetParError(2)));
  t1a.DrawLatex(0.15,0.75,Form("m = %.2e +/- %.2e   #sigma = %.2e +/- %.2e", fitF_100[3]->GetParameter(1), fitF_100[3]->GetParError(1),
   			     fitF_100[3]->GetParameter(2), fitF_100[3]->GetParError(2)));
  t1p.DrawLatex(0.15,0.7,Form("m = %.2e +/- %.2e   #sigma = %.2e +/- %.2e", fitF_100[4]->GetParameter(1), fitF_100[4]->GetParError(1),
  ...
  t10.DrawLatex(0.15,0.9,Form("m = %.2e +/- %.2e   #sigma = %.2e +/- %.2e", fitF_200[0]->GetParameter(1), fitF_200[0]->GetParError(1), 
			     fitF_200[0]->GetParameter(2), fitF_200[0]->GetParError(2)));
  t30.DrawLatex(0.15,0.85,Form("m = %.2e +/- %.2e   #sigma = %.2e +/- %.2e", fitF_200[1]->GetParameter(1), fitF_200[1]->GetParError(1), 
			     fitF_200[1]->GetParameter(2), fitF_200[1]->GetParError(2)));
  t3a.DrawLatex(0.15,0.8,Form("m = %.2e +/- %.2e   #sigma = %.2e +/- %.2e", fitF_200[2]->GetParameter(1), fitF_200[2]->GetParError(1), 
			     fitF_200[2]->GetParameter(2), fitF_200[2]->GetParError(2)));
  t1a.DrawLatex(0.15,0.75,Form("m = %.2e +/- %.2e   #sigma = %.2e +/- %.2e", fitF_200[3]->GetParameter(1), fitF_200[3]->GetParError(1),
			     fitF_200[3]->GetParameter(2), fitF_200[3]->GetParError(2)));
  t1p.DrawLatex(0.15,0.7,Form("m = %.2e +/- %.2e   #sigma = %.2e +/- %.2e", fitF_200[4]->GetParameter(1), fitF_200[4]->GetParError(1),
  ...
  t10.DrawLatex(0.15,0.9,Form("m = %.2e +/- %.2e   #sigma = %.2e +/- %.2e", fitF_300[0]->GetParameter(1), fitF_300[0]->GetParError(1), 
			     fitF_300[0]->GetParameter(2), fitF_300[0]->GetParError(2)));
  t30.DrawLatex(0.15,0.85,Form("m = %.2e +/- %.2e   #sigma = %.2e +/- %.2e", fitF_300[1]->GetParameter(1), fitF_300[1]->GetParError(1), 
			     fitF_300[1]->GetParameter(2), fitF_300[1]->GetParError(2)));
  t3a.DrawLatex(0.15,0.8,Form("m = %.2e +/- %.2e   #sigma = %.2e +/- %.2e", fitF_300[2]->GetParameter(1), fitF_300[2]->GetParError(1), 
			     fitF_300[2]->GetParameter(2), fitF_300[2]->GetParError(2)));
  t1a.DrawLatex(0.15,0.75,Form("m = %.2e +/- %.2e   #sigma = %.2e +/- %.2e", fitF_300[3]->GetParameter(1), fitF_300[3]->GetParError(1),
			     fitF_300[3]->GetParameter(2), fitF_300[3]->GetParError(2)));
  t1p.DrawLatex(0.15,0.7,Form("m = %.2e +/- %.2e   #sigma = %.2e +/- %.2e", fitF_300[4]->GetParameter(1), fitF_300[4]->GetParError(1),
